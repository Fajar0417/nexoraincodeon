...
import { createPortfolio, type PortfolioFormState } from "../actions";
  ...
  return (
    <form action={formAction} className="mt-8 max-w-2xl space-y-6">
      ...
      <button
        ...
        className="rounded-md bg-accent px-6 py-2.5 text-sm font-medium text-ink-900 transition-colors hover:bg-accent-dim disabled:opacity-60"
      >
        {pending ? "Menyimpan..." : "Simpan portfolio"}
      </button>
    </form>
  );
}
